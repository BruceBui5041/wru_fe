...
class LightTheme {
  ...
  static var themeLight = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      headline4: TextStyle(color: _colorMain, fontSize: 16),
      headline5: TextStyle(
          color: _colorMain, fontSize: 30, fontWeight: FontWeight.bold),
      headline6: TextStyle(color: _colorMain, fontSize: 60),
    ),
  );
}
